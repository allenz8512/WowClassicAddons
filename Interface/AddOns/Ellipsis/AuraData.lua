...
function Ellipsis:GetAurasDuration(spellName)
	return dataAuras[spellName]
end

function Ellipsis:SetAurasDuration(spellName,duration)
    dataAuras[spellName] = duration
    -- print(dataAuras[spellName])
    -- print(self:GetAurasDuration(spellName))
end