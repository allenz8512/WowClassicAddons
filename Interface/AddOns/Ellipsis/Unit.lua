...
function Unit:New(currentTime, groupBase, override, guid, unitName, unitClass, unitLevel)
    ...
    -- print("UnitNew:" .. "guid:" .. guid)
    -- print("override:" .. override .. " groupBase:" .. groupBase .. " group:" .. group)
    ...
    -- print("Unit:New 添加新单位anchorLookup[group]:")
    -- print(anchorLookup[group])
    -- print("return new ：" )
    -- print(new )
	return new
end
...
function Unit:Release()
	...
	self:Hide()
    -- print("Unit:Release() self.guid:" .. self.guid)
    -- print("Unit:Release() self:")
    -- print(self)
    -- print("Unit:Release() self.parentAnchor：")
    -- print(self.parentAnchor)
    -- print("Unit:Release() self.parentAnchor.RemoveUnit:")
    -- print(self.parentAnchor.RemoveUnit)
