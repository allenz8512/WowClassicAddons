...
--]]
local ChatFrameEditBox = DEFAULT_CHAT_FRAME.editBox
...
function AQButton_SetText()
  ...
  if (Allianceorhorde == 1) then
    ...
    QuestLeveltext:SetText(
      BLUE .. AQDiscription_LEVEL .. WHITE .. getglobal("Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_Level")
    )
    QuestAttainLeveltext:SetText(
      BLUE .. AQDiscription_ATTAIN .. WHITE .. getglobal("Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_Attain")
    )
    Prequesttext:SetText(
      BLUE ..
                                          ...
                                          getglobal("Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_Aim") ..
                                            "\n \n" ..
                                              BLUE ..
                                                AQDiscription_NOTE ..
                                                  WHITE ..
                                                    getglobal("Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_Note")
    )
    ...
    if
      ((AtlasORAlphaMap == "AlphaMap") and
        (getglobal("Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_Note_AlphaMap") ~= nil))
     then
      Prequesttext:SetText(
        BLUE ..
          AQDiscription_PREQUEST ..
                                                ...
                                                BLUE ..
                                                  AQDiscription_NOTE ..
                                                    WHITE ..
                                                      getglobal(
                                                        "Inst" ..
                                                          AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_Note_AlphaMap"
                                                      )
      )
    end
    ...
    for b = 1, 6 do
      ...
      if (getglobal("Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "ID" .. b) ~= nil) then
        ...
        local _, _, _, _, _, _, _, _, _, itemTexture = GetItemInfo(SHOWNID)
  ...
  if (Allianceorhorde == 2) then
                                            ...
                                            "\n \n" ..
                                              BLUE ..
                                                AQDiscription_NOTE ..
                                                  WHITE ..
                                                    getglobal(
                                                      "Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_HORDE_Note"
                                                    )
    )
    ...
    if
      ((AtlasORAlphaMap == "AlphaMap") and
        (getglobal("Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_HORDE_Note_AlphaMap") ~= nil))
     then
      Prequesttext:SetText(
        BLUE ..
          AQDiscription_PREQUEST ..
                          ...
                          "\n \n" ..
                            BLUE ..
                              AQDiscription_START ..
                                WHITE ..
                                  getglobal(
                                    "Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_HORDE_Location_AlphaMap"
                                  ) ..
                                    "\n \n" ..
                                      BLUE ..
                                        AQDiscription_AIM ..
                                                ...
                                                BLUE ..
                                                  AQDiscription_NOTE ..
                                                    WHITE ..
                                                      getglobal(
                                                        "Inst" ..
                                                          AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "_HORDE_Note_AlphaMap"
                                                      )
      )
    end
    for b = 1, 6 do
...
function AQgetItemInformation(count, what)
  ...
  if (Allianceorhorde == 2) then
    ...
    itemTEXTSAVED =
      getglobal("Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "ITC" .. count .. "_HORDE") ..
    ...
    itemTEXTSAVED =
      getglobal("Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST .. "ITC" .. count) ..
...
function AQColourCheck(arg1)
  ...
  if (AQQuestlevelf ~= nil or AQQuestlevelf ~= 0 or AQQuestlevelf ~= "") then
    if
      (AQQuestlevelf == UnitLevel("player") or AQQuestlevelf == UnitLevel("player") + 2 or
        AQQuestlevelf == UnitLevel("player") - 2 or
        AQQuestlevelf == UnitLevel("player") + 1 or
        AQQuestlevelf == UnitLevel("player") - 1)
     then
      AQQuestfarbe = Gelb
...
function AQFinishedQuest_OnClick()
  ...
  --save everything
  if (Allianceorhorde == 1) then
    AtlasQuest_Options[UnitName("player")]["AQFinishedQuest_Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST] =
      AQ["AQFinishedQuest_Inst" .. AQINSTANZ .. "Quest" .. AQSHOWNQUEST]
  elseif (Allianceorhorde == 2) then
...
-----------------------------------------------------------------------------
function AQGeneral_OnClick(self, arg1)
  -- first clear display
  AQClearALL()
  AQHideAL()
