...
function AtlasButton_OnClick(self)
	Atlas_Toggle(self);
end

function AtlasButton_Init(self)
...
function AtlasButton_Toggle(self)
...
function AtlasButton_UpdatePosition(self)
