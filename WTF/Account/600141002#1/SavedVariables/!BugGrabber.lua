...
BugGrabberDB = {
	...
	["errors"] = {
		{
			["message"] = "Interface\\AddOns\\AfterCast\\AfterCast.lua:337: attempt to index global 'this' (a nil value)",
			["time"] = "2019/10/04 00:45:07",
			["locals"] = "(*temporary) = nil\n(*temporary) = nil\n(*temporary) = nil\n(*temporary) = \"attempt to index global 'this' (a nil value)\"\nAfterCast_Command = <function> defined @Interface\\AddOns\\AfterCast\\AfterCast.lua:303\n",
			["stack"] = "Interface\\AddOns\\AfterCast\\AfterCast.lua:337: in function `AfterCast_OnLoad'\n[string \"*:OnLoad\"]:1: in function <[string \"*:OnLoad\"]:1>",
			["session"] = 275,
			["counter"] = 1,
		}, -- [1]
		{
			["message"] = "Frame RecipeRadarAvailabilityTooltip: Unknown script element OnTooltipAddMoney",
			["time"] = "2019/10/04 00:45:09",
			["session"] = 277,
			["counter"] = 9,
		}, -- [2]
		{
